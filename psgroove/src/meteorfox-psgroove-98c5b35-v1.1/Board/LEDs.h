...
DDRC  |=   LED_PORT_C_1_LED ; 

				
				/** set off leds */
				
				PORTB  &= ~LED_PORT_B_1_LED; 
PORTC  &= ~LED_PORT_C_1_LED; 
	...
	if (ActiveMask & (LEDMask & LED_PORT_C_1_LED)) {
																			PORTC |=  LED_PORT_C_1_LED;
																		}
																		if((~ActiveMask) & (LEDMask & LED_PORT_C_1_LED)) {
																			PORTC &= ~LED_PORT_C_1_LED;
	...
	if ((LEDMask & LED_PORT_C_1_LED) && (PORTC & LED_PORT_C_1_LED)) {
																			PORTC |=  LED_PORT_C_1_LED;
																		} else {
																			PORTC &= ~LED_PORT_C_1_LED;
																		}
